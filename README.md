...
2. If you already had the corresponding database driver installed on the machine when you installed PowerBuilder 2025 and selected Database Provider, you can just skip step#3 and step#4 below to run the PowerBuilder project directly. Otherwise, please follow the steps below to create the ODBC data source. 
